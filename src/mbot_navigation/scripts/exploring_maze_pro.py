...
class ExploringMaze():
    def __init__(self):  
        ...
        locations.append(Pose(Point(3.14146709442, 7.29029512405, 0.000),  Quaternion(0.000, 0.000, 0.319586748719, 0.947557022054)))  
######################################请补充更多位置（开始）######################################################
        locations.append(Pose(Point(0.327580958605,8.47869491577,0.0),Quaternion(0.0,0.0,-0.788218217411,0.615395841505)))
        locations.append(Pose(Point(3.93502664566,3.93502664566,0.0),Quaternion(0.0,0.0,3.93502664566,3.93502664566)))
        locations.append(Pose(Point(3.54651021957,3.54651021957,0.0),Quaternion(0.0,0.0,3.54651021957,0.675897184129)))
